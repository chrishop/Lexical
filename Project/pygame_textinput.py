#NOTE TO EXAMINER THIS IS NOT MY OWN WORK, IT IS SOMEONE ELSES WORK IM USING TO MAKE IT EASIER TO INPUT TEXT
...
class TextInput:
    ...
    def __init__(self, font_family = "",
        ...
        self.font_object = pygame.font.Font(os.path.dirname(os.path.realpath(__file__)) + "/" + "LiberationMono-Regular.ttf", font_size)
